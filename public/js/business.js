...
function appendContainer(noneEle,text, isError) {
...
function start() {
    const clientUserOne = new TurmsClient('ws://playground.turms.im:10510', 30 * 1000);
    const clientUserTwo = new TurmsClient('ws://playground.turms.im:10510', 30 * 1000);
    const USER_ONE_ID = '1';
    const USER_TWO_ID = '2';
    setupClient(null,clientUserOne, USER_ONE_ID, '123', USER_TWO_ID);
    setupClient(null,clientUserTwo, USER_TWO_ID, '123', USER_ONE_ID);
}
start();